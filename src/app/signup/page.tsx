      ...
      <div className="auth-card">
        ...
        <form className="auth-form" onSubmit={handleSubmit}>
          <div className="form-group">
            ...
            <input className="input-field" type="text" id="name" name="name" required value={formData.name} onChange={handleChange} placeholder="John Doe" />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <select className="input-field" id="role" name="role" value={formData.role} onChange={handleChange}>
